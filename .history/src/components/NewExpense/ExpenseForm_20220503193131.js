...
function ExpenseForm(props) {
  ...
  return (
    <form
      className="bg-gradient-to-r from-slate-800 to-slate-900 ... p-6 mx-8 h-auto flex flex-col sm:flex-row m-5 justify-between items-center h-auto"
    ...
    >
      <div className="">
        ...
        <div className="font-bold text-slate-100 text-xl mr-1 mt-1">
          Amount:
        </div>
        <input
          className="border-2 mr-4 ml-2 rounded-md p-1 hover:bg-slate-50 active:bg-slate-50"
      ...
      <div className="flex flex-grow space-x-10 items-center justify-center ">
        <button
          ...
          active:opacity-75 text-slate-50"
        >
          Add Item
        </button>
        <button
