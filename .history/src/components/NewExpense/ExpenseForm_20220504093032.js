...
function ExpenseForm(props) {
  ...
  return (
    <form className="bg-transparent ... p-6 mx-8 " onSubmit={handleSubmit}>
      <div className="flex flex-col sm:flex-row md:flex-row m-5 justify-between items-center h-auto">
